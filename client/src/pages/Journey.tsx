...
export const JOURNEYS: JourneyData[] = [
  ...
  },
  {
    ...
    description: "Para quem tem 500 seguidores mas ninguém pra ligar às 3h da manhã. Reconecte-se com as pessoas e consigo mesmo.",
    icon: "heart",
    color: "rose",
    gradientFrom: "#e11d48",
    gradientTo: "#fb7185",
    ...
    days: [
      ...
      { id: "con-12", day: 12, title: "Elogio Genuíno", description: "Elogie 3 pessoas hoje de forma específica. Não 'você é legal', mas 'admiro como você lida com...'", type: "desafio", duration: "dia todo" },
  ...
  },
  {
    ...
    days: [
      ...
      { id: "cresc-22", day: 22, title: "Conversa Elevadora", description: "Converse com alguém que pensa diferente de você. Não para debater, mas para aprender.", type: "desafio", duration: "variável" },
...
const INTRO_STEPS = [
  ...
  },
  {
    ...
    description: "Você só vê a atividade de hoje e as que já fez. Os próximos dias aparecem conforme você avança. Ver tudo de uma vez cria ruído mental e ansiedade. Aqui, você foca só no agora.",
    color: "text-blue-500",
  ...
  },
  {
    ...
    description: "Você começa com uma jornada. Ao completar, a próxima se abre. Cada jornada foi pensada para te preparar para a seguinte. Confie no processo, o teu caminho será personalizado pra você.",
