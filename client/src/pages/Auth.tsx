              ...
              <button
                onClick={() => {
                  if (googleClientId && window.google) {
                    ...
                    setError("Login com Google será disponibilizado em breve.");
                  }
                }}
                disabled={isSubmitting}
                className="w-full h-12 rounded-xl border border-border bg-white dark:bg-muted flex items-center justify-center gap-3 text-sm font-medium text-foreground hover:bg-muted/50 transition-all"
